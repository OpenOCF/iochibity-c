...
/****************************************************************
    BUTTON Resource Service Provider - implementation
 ****************************************************************/
/* REQUEST dispatcher */
...
OCEntityHandlerResult
svc_button_create_request (OCEntityHandlerRequest *oic_request,
...
OCEntityHandlerResult
svc_button_retrieve_request (OCEntityHandlerRequest *oic_request,
			  OCRepPayload **payload)
{
    OCEntityHandlerResult ehResult;
    return ehResult;
...
OCEntityHandlerResult
svc_button_update_request (OCEntityHandlerRequest *oic_request,
			OCRepPayload **payload)
{
    OCEntityHandlerResult ehResult;
    return ehResult;
...
OCEntityHandlerResult
svc_button_delete_request (OCEntityHandlerRequest *oic_request,
			OCRepPayload **payload)
{
    OCEntityHandlerResult ehResult;
    return ehResult;
...
void rmgr_register_button_rsvp (struct rsvp_button *rsvp)
{
